...
import com.azdev.testapp.databinding.FragmentBlank2Binding
...
//        }
        val myObject = Blank2FragmentArgs.fromBundle(arguments as Bundle).myObject
        binding.myText.text = myObject!!.name
